        ...
        <div className="py-6 px-4 max-w-7xl mx-auto">
            ...
            <div className="mb-6 flex flex-wrap items-center justify-between gap-4">
                ...
                <div>
                    <button
                        ...
                        className={`px-6 py-2.5 rounded-lg text-white font-medium shadow-md transition-all ${satisfactionStore.uploadErrorCount > 0 || rows.length === 0 || uploading
                                ? 'bg-gray-400 cursor-not-allowed shadow-none'
                                : 'bg-primary-600 hover:bg-primary-700 active:scale-95'
                            }`}
                    >
                        {satisfactionStore.isSaving ? (
            ...
            <div className="mb-6 flex flex-wrap items-center gap-4 text-sm font-medium">
                ...
                <button
                    type="button"
                    onClick={() => {
                        const currentTrustName = trustStore.selectedTrust?.trustName || name || "Trust Name";
                        const sampleData = [
                            {
