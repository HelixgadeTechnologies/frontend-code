    ...
    <div className="p-6 bg-gray-100 min-h-screen">
      ...
      <div className="flex items-center justify-between mb-9">
        ...
        <h1 className="text-xl font-bold text-gray-800">
          ...
          {dashboardStore.projectSwitch ? "Table" : "Dashboard"}
        </h1>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div className="bg-white p-3 rounded-md shadow-sm">
              <h3 className="font-semibold text-lg text-gray-600 mb-2">
                Number of host community members benefitting from livelihood/
                human capacity development initiatives implemented by HCDTs
              </h3>
            ...
            <div className="bg-white p-3 rounded-md shadow-sm">
              <h3 className="font-semibold text-lg text-gray-600 mb-2">
                {" "}
                Number of Trust community members who were locally employed by
                HCDT project contractors
              </h3>
              <div className="h-80 flex items-center justify-center">
      ...
      {dashboardStore.projectSwitch == true && <GeneralProjectTable />}
    </div>
  );
});
